...
export default function Index() {
  return (
    <Layout>
      ...
      <div className="container mx-auto px-4 py-24 lg:py-32">        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full mb-6 animate-fade-in">
            <Sparkles className="w-4 h-4 text-primary" />
            <span className="text-sm font-medium text-primary">Data Analyst & AI Explorer</span>
          </div>
          
      <h1 className="text-6xl md:text-8xl font-bold mb-6 leading-tight animate-fade-in-up">            Transforming data into{" "}
            <span className="gradient-text">clear insights</span> and smarter decisions
          </h1>
          
      <p className="text-2xl md:text-3xl text-muted-foreground mb-12 max-w-3xl mx-auto animate-fade-in-up animation-delay-200">            I help businesses with data analysis, dashboards, reporting, automation — and I am expanding into AI & data science
          </p>
